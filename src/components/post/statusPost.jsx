        ...
        return (
            <div className="container post-container">
                ...
                <div className="row statuspost-text">
                    <textarea className="form-control" rows="3" id="share-status" placeholder="Share your status now!" />
                </div>
                <div className="post-horizal-line" />
                <div className="row statuspost-submit">
                    <button type="button" className="btn btn-primary btn-post">Post</button>
                </div>
            </div>
        );
    }
